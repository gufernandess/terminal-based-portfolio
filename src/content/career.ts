  ...
  },
  {
    ...
    body: {
      ...
      pt: [
        ...
        'integrando Banco Efí (PIX/Boleto) e conversão de moedas, **reduzindo em',
        '~90% o tempo de conciliação bancária**. Elevação da cobertura de testes',
        'para acima de 80% com Jest e SonarQube.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    body: {
      ...
      pt: [
        ...
        '',
        'Implementação de API RESTful (Java, Maven, Selenium) que **automatizou',
        'por completo** um processo de coleta de dados de redes sociais antes',
        'manual, além de interface de BI para métricas de engajamento.',
      ],
    },
  },
];
